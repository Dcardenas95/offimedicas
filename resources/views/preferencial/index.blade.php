    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">Modulo preferencial
                        </div>
                        <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <h3>Por favor la persona {{ $user->nombre }} con turno #{{ $user->id }}
                                    acercarse a modulo Preferencial para ser atendido
                                </h3>
                                <p>por favor una vez atendida oprima el boton atender para que ingrese el siguiente paciente
                                </p>
                            </div>
                        </div>
